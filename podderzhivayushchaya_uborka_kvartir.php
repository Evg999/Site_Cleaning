<?php
    ...
    $current_page = 'podderzhivayushchaya_uborka_kvartir';
    $type_id =  '1';
...
?>
<head>
    <title>Поддерживающая уборка квартир в Москве и МО</title>
    <link rel="canonical" href="https://gosclean.ru/podderzhivayushchaya_uborka_kvartir">
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <div class="padding-10 pb-20">
            <p>
                Поддерживающая уборка квартир – Уборка которая обеспечивает постоянный порядок, без Ваших усилий.
                Чаще всего её делают раз в неделю. Включает в себя влажную уборку, удаление пыли, удаление известкового налета и мусора.
                Востребованная клининговая услуга, для поддержания чистоты в квартире. 
            </p>
            <p>
                Освободите свое время от ненужных забот, клинеры все сделают за Вас!
                Наша клининговая компания Госклин, выполняет уборку помещений, квартир, домов, коттеджей в Москве и Московской области, 
                качественно и по доступным ценам. На нашем счету уже более 250 000 уборок!
            </p>
            <p>
