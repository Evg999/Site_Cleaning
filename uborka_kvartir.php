...
<head>
    ...
    <link rel="canonical" href="https://gosclean.ru/uborka_kvartir">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <div class="containera">
            <table class="box735" style="width: 900px; border=0; align=center;">
                ...
                <tr>
                    <td>2-комнатная квартира<br>(до 60м2)</td>
                    <td>2950 руб.</td>
                    <td>5100 руб.</td>
                    <td>9600 руб.</td>
                    <td>7300 руб.</td>
                ...
                <tr>
                    <td>3-комнатная квартира<br>(до 80м2)</td>
                    <td>3450 руб.</td>
                    <td>6100 руб.</td>
                    <td>10600 руб.</td>
                    <td>9300 руб.</td>
                ...
                <tr>
                    <td>4-комнатная квартира<br>(до 100м2)</td>
                    <td>3950 руб.</td>
                    <td>7100 руб.</td>
                    <td>11600 руб.</td>
                    <td>11300 руб.</td>
                ...
                <tr>
                    <td>Свыше 100м2<br>(цена за 1м2)</td>
                    <td>80 руб.</td>
                    <td>100 руб.</td>
                    <td>120 руб.</td>
                    <td>90 руб.</td>
    ...
    <div class="faq" id="faq">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько времени займет уборка квартиры?</h2>
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Можно ли заказать только уборку сан.узла?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">Да, конечно! Вы можете заказать уборка сан.узла, минимальная сумма заказа по Москве 3 000р, по Московской области 4 000р.
            </div>
        </div>   
        <div class="faq-item">
            <div class="faq-item-question">
