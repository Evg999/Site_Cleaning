...
<?php
    ...
    $current_page = 'kompleksnaya_uborka';
...
<head>
    ...
    <link rel="canonical" href="https://gosclean.ru/kompleksnaya_uborka">
    <meta name="description" content="Услуги по комплексной уборке в Москве и МО  - ✅Мойка окон входит в стоимость - ✅Доступная цена">
</head>
<?php
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <div class="padding-10 pb-20">
            <p>
               Комплексную уборку желательно проводят не менее, чем 3-4 раза в год. Плюсы данной уборки, в неё входит 
            ...
            <p>
               Так же при проведении комплексной уборки, протираются все полки внутри шкафов, внутри моется духовой шкаф, холодильник и 
            ...
            <p>
                <b>В комплексную уборку уже входит доставка оборудования.</b>  
            </p>
            <p>
        ...
        <p class="price tit" style="width: 500px; border=0;">Цены на комплексную уборку домов, коттеджей</p>
        <div class="containera">
            <table class="box735 box505" style="width: 500px; border=0; align=center;">
                ...
                <tr>
                    ...
                    <td rowspan="1" class="f">130 руб.</td>
                    
                    
                </tr>
            </table>
        </div>
        <h3 class="padding-10">Что входит в комплексную уборку</h3>
        <div class="flex-box">
...
<div class="faq" id="faq">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Чем отличается комплексная уборка от генеральной уборки? </h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">
                В Комплексный клининг  входит, уборка всех шкафов внутри, моется холодильник внутри, микроволновая печь, духовой шкаф, 
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько по времени длится комплексная уборка ?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">За какое время необходимо заказать комплексную уборку? </h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">
                Оформить заказ на комплексную уборку квартиры в Москове и МО, желательно заранее запланировать, это маштабная уборка.
        ...
        <div class="faq-item">
            ...
            <div class="faq-item-answer">
                Доставка оборудования входит в комплексную уборку. 
            </div>
        </div> 
        <div class="faq-item">
            <div class="faq-item-question">
