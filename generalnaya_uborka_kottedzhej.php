<?php
    ...
    $current_page = 'generalnaya_uborka_kottedzhej';
    $type_id =  '1';
...
<head>
    ...
    <link rel="canonical" href="https://gosclean.ru/generalnaya_uborka_kottedzhej">
    
     <meta name="description" content="Генеральная уборка коттеджей – одни из наиболее востребованных клининговых услуг.
      Заказав генеральную уборку коттеджей в клининговой компании Вы можете освободить свое время от ненужных забот, клинеры все сделают за Вас!">
</head>
<?php
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <div class="padding-10 pb-20">
            <p>
                Генеральную уборку коттеджей необходимо проводить не менее 2 раз в месяц 
                Это рекомендуется для поддержания должного уровня чистоты, ведь чистота - залог здоровья!  
            </p>
            <p>
                Генеральная уборка коттеджей подразумевает под собой, тщательную уборку всех комнат, от пола до потолка. 
            ...
            <p>
                Уборка коттеджа в Москве и Московской области, загородного дома или таунхауса – непростая утомительная задача, требующая много времени и сил. 
                Не тратьте свою энергию на уборку, предоставьте это нам и закажите уборку дома в клининговой компании Госклин.
            </p>
        </div>
        <p class="price tit" style="width: 500px; border=0;">Цены на генеральную уборку коттеджей</p>
        <div class="containera">
            <table class="box735 box505" style="width: 500px; border=0; align=center;">
                ...
                <tr>
                    ...
                    <td rowspan="1" class="f">Ген. уборка</td>
        ...
        <div class="texts">
            <div class="containera">
                <h3 class="padding-10">Что входит в генеральную уборку домов и коттеджей</h3>
    ...
    <div class="faq" id="faq">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько сотрудников выезжают на генеральную уборку дома? </h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">
                На уборку дома или коттеджа, обычно выезжают от 2 до 5 клинеров. 
                Количество сотрудников может быть и больше, в зависимости от объема работ, площади помещения и степени загрязнения.
            </div>
        </div> 
        <div class="faq-item">
            <div class="faq-item-question">
            ...
            <div class="faq-item-answer">
                Время уборки зависит от степени загрязнения, сложности и площади.
                Например, поддерживающая уборка небольшого дома до 100кв м займет от 3 часов, а генеральная от 5 часов.
                Уборка коттеджа после ремонта потребует ещё больше времени, от 6 часов.
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Можно ли заказать генеральную уборку дома в Московской области?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Хочу генеральную уборку коттеджа, на постоянной основе?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">
                Мы можем заключить договор для уборки дома на постоянной основе.
                Оставьте заявку, Наши менеджеры уточнят количество уборок в месяц и дни, когда Вам удобно чтобы производилась уборка дома.
