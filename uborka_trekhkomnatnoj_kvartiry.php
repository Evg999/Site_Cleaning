<?php
    ...
    $current_page = 'uborka_trekhkomnatnoj_kvartiry';
    $type_id =  '1';
...
<head>
    ...
    <link rel="canonical" href="https://gosclean.ru/uborka_trekhkomnatnoj_kvartiry">
    
     <meta name="description" content="Генеральная уборка двухкомнатной квартиры, уборка двухкомнатной квартиры после ремонта, или поддерживающая уборка двухкомнатной квартиры 
     – одни из наиболее востребованных клининговых услуг. Заказав уборку квартиры в клининговой компании Вы можете освободить свое время от ненужных забот, клинеры все сделают за Вас!">
</head>
<?php
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <p class="price tit">Цены на уборку трехкомнатной квартиры</p>
        <div class="containera">
            <table class="box735" style="width: 900px; border=0; align=center;">
                ...
                <tr>
                    <td>3-комнатной квартира<br>( до 80 м2)</td>
                    <td>3450 руб.</td>
                    <td>6100 руб.</td>
                    <td>10600 руб.</td>
                    <td>9300 руб.</td>
    ...
    <div class="faq" id="faq">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько времени займет уборка трехкомнатной квартиры?</h2>
            ...
            <div class="faq-item-answer">
                ...
                Например, поддерживающая уборка трехкомнатной квартиры займет 3,5 часа, а генеральная уборка трехкомнатной квартиры займет от 4,5 часов.
                Уборка квартиры после ремонта потребует ещё больше времени, от 5 часов.
            </div>
        </div>   
        <div class="faq-item">
            <div class="faq-item-question">
