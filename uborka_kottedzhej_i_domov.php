...
<?php
    ...
    $current_page = 'uborka_kottedzhej_i_domov';
    $type_id =  '1';
...
?>
<head>
    <title>Уборка коттеджей в Москве и МО, цена на профессиональную уборку загородных домов</title>
    <link rel="canonical" href="https://gosclean.ru/uborka_kottedzhej_i_domov">
    
    <meta name="description" content="Услуги по уборке коттеджей и частных домов в Москве - ⭐Профессионализм боее 5 лет опыта - ✅100% страхование - ✅Доступная стоимость Уборка коттеджа в Москве и Московской области, загородного дома или таунхауса, закажите уборку дома в клининговой компании Госклин">
</head>
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <div class="padding-10 pb-20">
            <p>
                <a href="https://gosclean.ru/generalnaya_uborka_kottedzhej">Генеральная уборка коттеджей</a>, <a href="">уборка коттеджей после ремонта </a>или<a href=""> поддерживающая 
                уборка коттеджей</a> – одни из наиболее востребованных клининговых услуг. 
                Заказав уборку дома в клининговой компании, 
            ...
            <p>
                Профессиональная и качественная уборка коттеджей, выполняется благодаря нашим опытным клинерам, 
                профессиональному оборудованию и специально подобранным профессиональным моющим средствам.
            </p>
        </div>
        <p class="price tit">Цены на уборку коттеджей и домов</p>
        <div class="containera">
            <table class="box735" style="width: 900px; border=0; align=center;">
                ...
                <tr>
                    <td rowspan="2" class="f"> Уборка коттеджей и домов </td>
        ...
        <div class="texts">
            ...
            <div class="containera">
                <table class="box736" style="width: 900px; border=0; align=center">
                    <tbody>
                        <tr>
    ...
    <div class="faq" id="faq">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько времени займет уборка Дома?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">Время уборки зависит от степени загрязнения, сложности и площади дома.
                Например, поддерживающая уборка дома 150кв м, займет 2-3 часа, а генеральная уборка загородного дома займет от 4-5 часов.
                Уборка после ремонта потребует ещё больше времени, от 5-6 часов. Возможен выезд бригады(оговаривается заранее)
            </div>
        </div> 
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько сотрудников выезжают на уборку загородного дома?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">На уборку дома или коттеджа, обычно выезжают от 1 до 5 
                клинеров. Количество сотрудников может быть и больше, в зависимости от объема работ, 
                площади помещения и степени загрязнения.
            </div>
        </div> 
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Обязательно ли во время уборки находится в доме?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">Нет. Вы сами выбираете, как Вам удобнее, в любом случае после уборки, перед оплатой, Вы принимаете работы!
            </div>
        </div> 
        <div class="faq-item">
            <div class="faq-item-question">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Можно ли заказать уборку коттеджа в Подмосковье?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Можно ли заказать уборку дома на еженедельной основе?</h2>
                    <img class=down-arrow src="img/down-arrow.png" alt="стрелка">
                </div>
            </div>
            <div class="faq-item-answer">Да! Для этого Вам необходимо будет обсудить с нашим менеджером, график уборок, выбрать день недели, время и уборку, 
                которая Вас интересует. За день до уборки Вам будет поступать сообщение или звонок менеджера для подтверждения заказа!
            </div>
        </div> 
    </div> 
