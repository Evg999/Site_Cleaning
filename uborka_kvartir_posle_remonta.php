...
<?php
    ...
    $current_page = 'uborka_kvartir_posle_remonta';
     $type_id =  '1';
...
?>
    <head>
        ...
        <link rel="canonical" href="https://gosclean.ru/uborka_kvartir_posle_remonta">
        
        <meta name="description" content="Услуги по уборке после ремонта квартир в Москве - ✅Большой опыт работы - ✅Гарантия качества">
    </head>
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <div class="padding-10 pb-20">
            <p>
               Уборка квартиры после ремонта, завершающий этап каждого ремонта. Она включает в себя удаление строительной пыли, влажную уборку. 
               Это необходимое мероприятие, без которого новый интерьер не будет соответствовать ожиданиям.
            </p>
            <p>
               Радость от того, что ремонт в квартире наконец-то закончен, бывает неполной, так как ее омрачает предстоящая глобальная 
        ...
        <p class="price tit" style="width: 600px; border=0;">Цены на уборку после ремонта квартир</p>
