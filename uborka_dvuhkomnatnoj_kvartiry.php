<?php
    ...
    $current_page = 'uborka_dvuhkomnatnoj_kvartiry';
    $type_id =  '1';
...
<head>
    ...
    <link rel="canonical" href="https://gosclean.ru/uborka_dvuhkomnatnoj_kvartiry">
...
<div class="wrapper1">
    ...
    <div class="main wrapper-900 text-align-center">
        ...
        <p class="price tit">Цены на уборку двухкомнатной квартиры</p>
        <div class="containera">
            <table class="box735" style="width: 900px; border=0; align=center;">
                ...
                <tr>
                    <td>2-комнатная квартира<br>( до 60 м2)</td>
                    <td>2950 руб.</td>
                    <td>5100 руб.</td>
                    <td>9600 руб.</td>
                    <td>7300 руб.</td>
    ...
    <div class="faq" id="faq">
        ...
        <div class="faq-item">
            <div class="faq-item-question">
                <div class="between">
                    <h2 class="que">Сколько времени займет уборка двухкомнатной квартиры?</h2>
            ...
            <div class="faq-item-answer">
                ...
                Например, поддерживающая уборка двухкомнатной квартиры займет 3 часа, а генеральная уборка двухкомнатной квартиры займет от 4 часов.
                Уборка квартиры после ремонта потребует ещё больше времени, от 4,5 часов.
            </div>
        </div>   
        <div class="faq-item">
            <div class="faq-item-question">
